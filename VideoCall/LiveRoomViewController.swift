...
//    }
    func addLocalSession() {
        ...
        // Set the mirror mode for the local video canvas
        let videoCanvas = localSession.canvas
        videoCanvas.mirrorMode = .auto  // or set it to .enabled or .disabled depending on your needs
